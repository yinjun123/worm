...
if __name__ == '__main__':
    print("欢迎使用百度图片下载爬虫多个关键字请用空格进行分割")
    # print("下载结果保存在脚本目录下的img文件夹中。")
    choosePath = input('请输入你想保存的路径方式  1. 默认路径 path = IMGS/   2. 相对路径 path_input/path_input/  3. 绝对路径,比如 D:/IMG/\n')
    if int(choosePath) == 3:
    ...
    chooseImgType = input('请选择你要保存的图片格式  0. default: jpg  1. jpg  2. png  3. gif  4. 自定义')
    ...
    strtag = input("请输入您要下载图片名字,最后格式为 number+' ' +name.%s" % imgType)
